...
@section('title')
    Cập nhập sản phẩm: {{ $product['name'] }}
@endsection
                ...
                <div class="white_card_header">
                    <div class="box_header m-0">
                        <div class="main-title">
                            <h1 class="m-0">Cập nhập sản phẩm: {{ $product['name'] }}</h1>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" class="form-control" id="discount_price"
                                            placeholder="Enter discount_price" value="{{ $product['discount_price'] }}"
                                            name="discount_price">
                                    </div>
                                    <div class="mb-3 mt-3">
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <textarea class="form-control" id="content" placeholder="Enter content" name="content">{{ $product['content'] }}</textarea>
                                    </div>
                                </div>
                            </div>
